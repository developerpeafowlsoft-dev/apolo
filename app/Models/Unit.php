...
class Unit extends Model
{
    ...
    /**
     * Check if this unit is owned and editable/deletable by a shop.
     */
    public function isOwnedByShop(?int $shopId): bool
    {
        ...
        // Units created by Super Admin (user 1 or root role) or system migrated (no creator) are protected
