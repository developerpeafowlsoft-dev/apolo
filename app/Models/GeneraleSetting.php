...
//    }
    ...
    public function logo(): Attribute
    {
        return new Attribute(
            get: function () {
                if ($this->mediaLogo && Storage::disk('public')->exists($this->mediaLogo->src)) {
                    return Storage::url($this->mediaLogo->src);
                }
...
//    }
    ...
    public function appLogo(): Attribute
    {
        return new Attribute(
            get: function () {
                $defaultLogo = asset('assets/favicon.png');

                if ($this->mediaAppLogo && Storage::disk('public')->exists($this->mediaAppLogo->src)) {
                    return Storage::url($this->mediaAppLogo->src);
                }
...
//    }
    ...
    public function favicon(): Attribute
    {
        return new Attribute(
            get: function () {
                $defaultFavicon = asset('assets/favicon.png');

                if ($this->mediaFavicon && Storage::disk('public')->exists($this->mediaFavicon->src)) {
                    return Storage::url($this->mediaFavicon->src);
                }
...
//    }
    ...
    public function footerLogo(): Attribute
    {
        return new Attribute(
            get: function () {
                $defaultLogo = asset('assets/logoWhite.png');

                if ($this->mediaFooterLogo && Storage::disk('public')->exists($this->mediaFooterLogo->src)) {
                    return Storage::url($this->mediaFooterLogo->src);
                }
...
//    }
    ...
    public function footerQr(): Attribute
    {
        return new Attribute(
            get: function () {
                if ($this->mediaFooterQr && Storage::disk('public')->exists($this->mediaFooterQr->src)) {
                    return Storage::url($this->mediaFooterQr->src);
                }
