...
class ProductRepository extends Repository
{
    ...
    public static function storeByItemRequest(ItemMasterRequest $request): Product
    {
        ...
        $product = self::create([
            ...
            'code' => $request->code,
            'hsn_master_id' => $request->hsn_master_id,
...
//            'quantity' => $request->quantity ?? 0,
            ...
            'is_online_product' => filled($request->is_online_product) ? 1 : 0,
            'is_item_master' => 1
        ]);
...
//        }
    ...
    public static function updateByItemRequest(ItemMasterRequest $request, Product $product): Product
    {
...
//            'quantity' => $request->quantity ?? 0,
            'salesman_id' => $request->salesman_id ?? null,
            'commission_type' => $request->commission_type ?? null,
            'salesman_comm' => ($request->commission_type == 1 ? $request->salesman_comm : 0),
            'salesman_comm_amt' => ($request->commission_type == 2 ? $request->salesman_comm_amt : 0),
            'is_online_product' => filled($request->is_online_product) ? 1 : 0,
        ]);
