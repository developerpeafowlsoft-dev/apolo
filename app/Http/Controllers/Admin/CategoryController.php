...
class CategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Get all categories (Super Admin created + Shop created) with search and pagination
        $categories = Category::with('shop')
        ...
        return view('admin.category.index', compact('categories', 'rootShop'));
    }
