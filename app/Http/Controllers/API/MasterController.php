...
class MasterController extends Controller
{
    ...
    public function index()
    {
        ...
        return $this->json('Master data', [
            ...
            'mobile' => $generaleSetting?->mobile ?? $generaleSetting?->footer_phone ?? '+880123456789',
            'email' => $generaleSetting?->email ?? $generaleSetting?->footer_email ?? config('mail.from.address') ?? 'apolo@gmail.com',
