...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'online_discount_percent' => 'nullable|numeric|min:0|max:99.99',
            'variant_online_discount' => 'nullable|array',
            'variant_online_discount.*' => 'nullable|numeric|min:0|max:99.99',
