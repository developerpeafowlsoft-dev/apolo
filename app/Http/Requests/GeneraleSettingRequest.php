...
class GeneraleSettingRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'shiprocket_pickup_pincode.numeric' => __('The Shiprocket pickup pincode must be numeric.'),
            'shiprocket_pickup_pincode.digits' => __('The Shiprocket pickup pincode must be a 6-digit postal code.'),
        ];
    }
}
