...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'checkShopOwner' => \App\Http\Middleware\CheckShopOwner::class,
        'requires-internet' => \App\Http\Middleware\EnforceBranchModeRestrictions::class,
        'branch.auth' => \App\Http\Middleware\AuthenticateBranchApiKey::class,
    ];
}
