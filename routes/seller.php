...
Route::prefix('/seller')->group(function () {
    ...
    Route::controller(LoginController::class)->group(function () {
        ...
        Route::post('/forgot-password', 'forgotPassword')->middleware('requires-internet');
        Route::post('/send-otp', 'sendOTP')->middleware('requires-internet');
        Route::post('/verify-otp', 'verifyOtp')->middleware('requires-internet');
