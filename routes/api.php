...
Route::controller(ForgotPasswordController::class)->middleware('requires-internet')->group(function () {
...
Route::middleware(['auth:sanctum', 'role:customer'])->group(function () {
    ...
    Route::controller(CartController::class)->group(function () {
        ...
        Route::post('/cart/buy-now-clear', 'clearBuyNow');
    });
...
Route::match(['get', 'head'], '/central/ping', function () {
    return response()->json(['status' => 'ok']);
});

Route::post('/central/sync-ingest', [\App\Http\Controllers\API\Central\SyncIngestController::class, 'store'])->middleware('branch.auth');
