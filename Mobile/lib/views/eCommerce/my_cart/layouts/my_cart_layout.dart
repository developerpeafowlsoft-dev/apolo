            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      ref.watch(cartSummeryController)['applyCoupon'] ? S.of(context).applied : S.of(context).apply,
                      style: AppTextStyle(context).subTitle.copyWith(color: colors(context).primaryColor),
                    ),
                  ],
                ),
              ),
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () async {
                          ...
                          context.nav.pushNamed(
                            ...
                            arguments: [
                              double.parse(_getPayableAmount()),
                              promoCodeController.text.isNotEmpty ? promoCodeController.text.trim() : null,
                              widget.isBuynow,
                              isDigital,
                              ref.read(shopIdsProvider).toList(),
                            ],
                          );
                        },
