    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-body p-3">
            ...
            @php
                ...
                if (!isset($statusCounts)) {
                    ...
                    if ($generaleSetting?->shop_type == 'single') {
                        $shop = \App\Models\User::role(\App\Enums\Roles::ROOT->value)->first()?->shop;
                    }
            ...
            @endphp
                    ...
                    @endphp
                    <li class="nav-item">
                        <a href="{{ route('admin.order.index', str_replace(' ', '_', $statusItem->value)) }}"
                            class="nav-link {{ request()->url() === route('admin.order.index', str_replace(' ', '_', $statusItem->value)) ? 'active' : '' }}">
