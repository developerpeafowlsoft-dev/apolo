...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        ...
        <div class="d-flex align-items-center gap-3 flex-wrap">
            <form action="{{ route('admin.subcategory.index') }}" method="GET" class="d-flex align-items-center">
                <div class="input-group">
                    ...
                    @if(request('search'))
                        <a href="{{ route('admin.subcategory.index') }}" class="btn btn-outline-secondary border-start-0" title="{{ __('Clear Search') }}">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <label class="switch mb-0">
                                        <a href="{{ route('admin.subcategory.toggle', $subCategory->id) }}" title="{{ __('Toggle Status') }}">
                                ...
                                <td class="text-center">
                                    <div class="d-flex gap-2 justify-content-center">
                                        <a href="{{ route('admin.subcategory.edit', $subCategory->id) }}" class="btn btn-outline-primary circleIcon" title="{{ __('Edit') }}">
