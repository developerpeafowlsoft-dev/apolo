        ...
        <div class="clearfix w-full">
            ...
            <table class="invoice-details">
                <tr>
                    ...
                    <th class="text-left">{{ __('Billed By (Cashier)') }}</th>
                    <th class="text-right">{{ __('Salesperson') }}</th>
                </tr>
                <tr>
                    <td>{{ is_string($order->payment_method) ? $order->payment_method : ($order->payment_method->value ?? $order->payment_method) }}</td>
                    <td>#{{ $order->prefix . $order->order_code }}</td>
                    <td>{{ $order->cashier?->name ?? 'POS Cashier' }}</td>
                    <td class="text-right">{{ $order->salesman?->name ?? 'Direct' }}</td>
                </tr>
            </table>
