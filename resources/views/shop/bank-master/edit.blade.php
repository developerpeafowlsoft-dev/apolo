...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        <h4>
            {{__('Update Bank Master')}}
        </h4>
    </div>
    <form id="formData" action="{{route('shop.bankMaster.update',$bankMaster->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6 col-lg-3">
                        <x-input type="text" name="bank_name" label="Bank Name" placeholder="Enter Bank Name" value="{{ old('bank_name',$bankMaster->bank_name) }}" required="true"/>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="short_name" name="short_name"
                               ...
                               class="form-control @error('short_name') is-invalid @enderror" value="{{ old('short_name',$bankMaster->short_name) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-select label="Account Group" name="account_group_id" required="true">
                            @foreach ($accounts_groups as $accounts_group)
                                <option value="{{ $accounts_group->id }}" {{ old('account_group_id',$bankMaster->account_group_id) == $accounts_group->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="bank_ac_no" name="bank_ac_no"
                               ...
                               class="form-control @error('bank_ac_no') is-invalid @enderror" value="{{ old('bank_ac_no',$bankMaster->bank_ac_no) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="bank_branch" name="bank_branch"
                               ...
                               class="form-control @error('bank_branch') is-invalid @enderror" value="{{ old('bank_branch',$bankMaster->bank_branch) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="bank_swift_code" name="bank_swift_code"
                               ...
                               class="form-control @error('bank_swift_code') is-invalid @enderror" value="{{ old('bank_swift_code',$bankMaster->bank_swift_code) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="bank_ifsc_code" name="bank_ifsc_code"
                               ...
                               class="form-control @error('bank_ifsc_code') is-invalid @enderror" value="{{ old('bank_ifsc_code',$bankMaster->bank_ifsc_code) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <textarea name="bank_address" class="form-control @error('bank_address') is-invalid @enderror" rows="1" placeholder="Enter Address" required="true">{{ old('bank_address',$bankMaster->bank_address) }}</textarea>
                        @error('bank_address')
                        <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
