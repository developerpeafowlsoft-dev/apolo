...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        <h4>
            {{__('Update Counter Master')}}
        </h4>
    </div>

    <form id="formData" action="{{route('shop.counterMaster.update',$counterMaster->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <div class="input-group flex-nowrap">
                            <input type="text" class="form-control disabledCls @error('code') is-invalid @enderror" name="code" placeholder="Code" id="shortCode" value="{{ old('code',$counterMaster->code) }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 4);" required="true" readonly>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="counter_name" name="counter_name"
                               ...
                               class="form-control @error('counter_name') is-invalid @enderror" value="{{ old('counter_name',$counterMaster->counter_name) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="counter_short_name" name="counter_short_name"
                               ...
                               class="form-control @error('counter_short_name') is-invalid @enderror" value="{{ old('counter_short_name',$counterMaster->counter_short_name) }}"
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="floor" name="floor"
                               ...
                               class="form-control @error('floor') is-invalid @enderror" value="{{ old('floor', $counterMaster->floor) }}"
                               maxlength="100"
                        />
                        @error('floor')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="col-md-6 col-lg-3">
                        ...
                        <input type="text" id="voucher_prefix" name="voucher_prefix"
                               ...
                               class="form-control @error('voucher_prefix') is-invalid @enderror" value="{{ old('voucher_prefix',$counterMaster->voucher_prefix) }}"
