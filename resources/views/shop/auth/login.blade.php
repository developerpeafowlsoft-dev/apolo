...
<head>
    ...
    <meta name="description" content="{{ $generaleSetting?->name ?? config('app.name', 'Apolo') }} Shop Login">
    ...
    <!-- App title -->
    <title>{{ $generaleSetting?->title ?? config('app.name', 'Apolo') }} - Shop Portal Login</title>
            ...
            <div class="row g-0">
                ...
                <div class="col-lg-6 hero-column">
                    ...
                    <div class="hero-illustration-box">
                        ...
                        <img src="{{ asset('assets/images/shop-login.png') }}" alt="Shop Management Illustration" loading="lazy" />
                ...
                <div class="col-lg-6 form-column">
                    ...
                    <div class="auth-brand-header">
                        ...
                        <h2 class="auth-headline">Login To Shop</h2>
                    ...
                    <!-- Login Form -->
                    <form action="{{ route('shop.login.submit') }}" method="POST" autocomplete="on">
                        @csrf
                        ...
                        <div class="form-group-modern">
                            ...
                            <div class="input-wrapper-modern">
                                ...
                                <input type="email"
                                       ...
                                       placeholder="shop@readyecommerce.com"
                                       required
                                       autofocus>
                            </div>
                            @error('email')
                        ...
                        @if (!app()->isLocal())
                            <div class="mt-3 text-center">
                                <a href="{{ route('shop.register') }}" class="btn btn-outline-secondary btn-sm w-100 rounded-3 py-2 fw-semibold" style="border-color: #cbd5e1; color: #475569;">
                                    <i class="bi bi-person-plus-fill me-1"></i> Register As Seller
                                </a>
                            </div>
                        @endif
                            ...
                            <div class="demo-credentials-card">
                                ...
                                <div class="demo-grid">
                                    <div class="demo-pill">
                                        ...
                                        <button type="button" class="demo-copy-btn" onclick="loginShop()" title="Auto-fill Shop">
                                    ...
                                    <div class="demo-pill">
                                        <div class="demo-info">
                                            <div class="demo-role">Admin Portal</div>
                                            <div class="demo-sub font-monospace" style="font-size: 11px;">root@readyecommerce.com</div>
                                        </div>
                                        <button type="button" class="demo-copy-btn" onclick="gotoAdminLogin()" title="Open Admin Login">
    ...
    <script>
        ...
        function loginShop() {
            ...
            if (!sessionStorage.getItem('fromAdmin')) {
                Toast.fire({
                    icon: 'success',
                    title: 'Shop Credentials Auto-Filled'
                });
            }
        }
