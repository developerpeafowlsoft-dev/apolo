...
@section('content')
    <div class="d-flex align-items-center flex-wrap gap-3 justify-content-between px-3">
        <h4>
            {{__('Add Account Master')}}
        </h4>
    </div>

    <form id="formData" action="{{route('shop.accountMaster.store')}}" method="POST" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="row g-3">
                            <div class="col-md-6 col-lg-6">
                                <x-input type="text" name="accountName" label="Account Name" placeholder="Enter Account Name" value="{{ old('accountName') }}" required="true"/>
                            </div>
                            <div class="col-md-6 col-lg-6">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <x-select label="Region / Area" name="cities_id" required="true">
                                    <option value="">Select a region/area</option>
                                    @if(old('cities_id'))
                                        @php
                                            $oldCity = \App\Models\City::find(old('cities_id'));
                                        @endphp
                                        @if($oldCity && !$citys->contains('id', $oldCity->id))
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <div class="input-group flex-nowrap">
                                    <input type="text" class="form-control disabledCls @error('accountshortcode') is-invalid @enderror" name="accountshortcode" placeholder="Short Code" id="shortCode" value="{{ old('accountshortcode') }}" oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);" required="true" readonly>
                            ...
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input type="text" id="agentcomm" name="agentcomm"
                                       ...
                                       class="form-control @error('agentcomm') is-invalid @enderror" value="{{ old('agentcomm','0.00') }}"
                            ...
                            <div class="col-md-6 col-lg-4">
                                <x-input type="text" name="agentcommremark" label="Remark" placeholder="Enter Remark" value="{{ old('agentcommremark') }}" />
                            </div>

                            <div class="col-md-6 col-lg-8">
                                <x-input type="text" name="referenceby" label="Reference By" placeholder="Reference By" value="{{ old('referenceby') }}" />
                            </div>

                            <div class="col-md-6 col-lg-4 d-flex align-items-center mt-3">
                                <div class="form-check form-switch fs-5 pt-3">
                                    <input class="form-check-input" type="checkbox" name="is_party_code" id="is_party_code" value="1" {{ old('is_party_code', '1') == '1' ? 'checked' : '' }}>
                ...
                <div class="col-12 col-md-6">
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-6">
                                    <x-input type="text" name="contperson" label="Contact Person" placeholder="Enter Contact Person" value="{{ old('conperson') }}" required="true"/>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="contpincode" name="contpincode"
                                           ...
                                           class="form-control @error('contpincode') is-invalid @enderror" value="{{ old('contpincode') }}"
                                ...
                                <div class="col-md-6 col-lg-12">
                                    ...
                                    <textarea name="contaddress" class="form-control @error('contaddress') is-invalid @enderror" rows="1" placeholder="Enter Contact Address" required="true">{{ old('contaddress') }}</textarea>
                                    @error('contaddress')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <x-select label="Country" name="country_id" required="true">
                                        ...
                                        @if(old('country_id'))
                                            @php
                                                $oldCountry = \App\Models\Country::find(old('country_id'));
                                            @endphp
                                            @if($oldCountry)
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <x-select label="State" name="state_id" required="true">
                                        ...
                                        @if(old('state_id'))
                                            @php
                                                $oldState = \App\Models\State::find(old('state_id'));
                                            @endphp
                                            @if($oldState)
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <x-select label="City" name="city_id" required="true">
                                        ...
                                        @if(old('city_id'))
                                            @php
                                                $oldCity = \App\Models\City::find(old('city_id'));
                                            @endphp
                                            @if($oldCity)
                                                <option value="{{ $oldCity->id }}" selected>{{ $oldCity->name }}</option>
                                            @endif
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="cont_info_mobile1" name="cont_info_mobile1"
                                           ...
                                           class="form-control @error('cont_info_mobile1') is-invalid @enderror" value="{{ old('cont_info_mobile1') }}"
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="cont_info_mobile2" name="cont_info_mobile2"
                                           ...
                                           class="form-control @error('cont_info_mobile2') is-invalid @enderror" value="{{ old('cont_info_mobile2') }}"
                                           oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);"
                                           maxlength="10"/>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <input type="text" id="cont_info_phone" name="cont_info_phone"
                                           ...
                                           class="form-control @error('cont_info_phone') is-invalid @enderror" value="{{ old('cont_info_phone') }}"
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <div class="d-block gap-3 mt-0 mt-md-3">
                                        <div class="form-check">
                                            <input type="checkbox" id="cont_info_send_sms" name="cont_info_send_sms" class="form-check-input" {{ old('cont_info_send_sms') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="cont_info_send_sms">{{ __('Send SMS') }}</label>
                                        </div>

                                        <div class="form-check">
                                            <input type="checkbox" id="cont_info_dndactivate" name="cont_info_dndactivate" class="form-check-input" {{ old('cont_info_dndactivate') ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <x-input type="email" name="cont_info_email" label="Email" placeholder="Enter Email Address" value="{{ old('cont_info_email') }}"/>
                                </div>

                                <div class="col-md-6 col-lg-4">
                                    <x-input type="url" name="cont_info_website_url" label="Website URL" placeholder="Enter Website URL" value="{{ old('cont_info_website_url') }}"/>
                                </div>

                                <div class="col-md-6 col-lg-4">
                                    <x-input type="date" name="cont_info_birth_date" label="Birth Date" value="{{ old('cont_info_birth_date') }}"/>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <div class="input-group flex-nowrap">
                                        <input type="text" class="form-control @error('tax_info_gst_no') is-invalid @enderror" name="tax_info_gst_no" placeholder="Enter GST No." id="tax_info_gst_no" value="{{ old('tax_info_gst_no') }}" required="true" pattern="^[0-9]{2}[A-Z]{5}[0-9]{4}[A-Z]{1}[1-9A-Z]{1}Z[0-9A-Z]{1}$" title="Enter a valid GST Number (e.g., 22AAAAA0000A1Z5)" maxlength="15">
                                ...
                                <div class="col-md-6 col-lg-3">
                                    <x-input type="date" name="tax_info_gst_reg_date" label="GST Reg. Date" value="{{ old('tax_info_gst_reg_date') }}"/>
                                </div>

                                <div class="col-md-6 col-lg-3">
                                    <x-input type="date" name="tax_info_gst_cancel_date" label="GST Cancel Date" value="{{ old('tax_info_gst_cancel_date') }}"/>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-4">
                                    <x-select label="Tax Type" name="vat_tax_id">
                                        ...
                                        @foreach ($taxs as $tax)
                                            <option value="{{ $tax->id }}" {{ old('vat_tax_id') == $tax->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="tax_info_tan_no" name="tax_info_tan_no"
                                           ...
                                           class="form-control @error('tax_info_tan_no') is-invalid @enderror" value="{{ old('tax_info_tan_no') }}"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="tax_info_pan_no" name="tax_info_pan_no"
                                           ...
                                           class="form-control  @error('tax_info_pan_no') is-invalid @enderror" value="{{ old('tax_info_pan_no') }}"
                                ...
                                <div class="col-md-12 col-lg-12">
                                    <div class="d-flex gap-3">
                                        <div class="form-check">
                                            <input type="checkbox" id="tax_info_tds_deduct" name="tax_info_tds_deduct" class="form-check-input" {{ old('tax_info_tds_deduct') ? 'checked' : '' }}>
                                            <label class="form-check-label" for="tax_info_tds_deduct">{{ __('TDS Deduct') }}</label>
                                        </div>

                                        <div class="form-check">
                                            <input type="checkbox" id="tax_info_tcs_deduct" name="tax_info_tcs_deduct" class="form-check-input" {{ old('tax_info_tcs_deduct') ? 'checked' : '' }}>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_discount" name="other_info_discount"
                                           ...
                                           class="form-control @error('other_info_discount') is-invalid @enderror" value="{{ old('other_info_discount','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_discount_limit" name="other_info_discount_limit"
                                           ...
                                           class="form-control @error('other_info_discount_limit') is-invalid @enderror" value="{{ old('other_info_discount_limit','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_cash_disc" name="other_info_cash_disc"
                                           ...
                                           class="form-control @error('other_info_cash_disc') is-invalid @enderror" value="{{ old('other_info_cash_disc','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_special_disc" name="other_info_special_disc"
                                           ...
                                           class="form-control @error('other_info_special_disc') is-invalid @enderror" value="{{ old('other_info_special_disc','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_bank_cs_disc" name="other_info_bank_cs_disc"
                                           ...
                                           class="form-control @error('other_info_bank_cs_disc') is-invalid @enderror" value="{{ old('other_info_bank_cs_disc','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_credit_day" name="other_info_credit_day"
                                           ...
                                           class="form-control @error('other_info_credit_day') is-invalid @enderror" value="{{ old('other_info_credit_day','0') }}"
                                           oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10);"
                                    />
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="other_info_act_limit" name="other_info_act_limit"
                                           ...
                                           class="form-control @error('other_info_act_limit') is-invalid @enderror" value="{{ old('other_info_act_limit','0.00') }}"
                                           oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                    />
                ...
                <div class="col-12 col-md-6">
                    <div class="card mt-4 mb-4">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-6 col-lg-4">
                                    <x-input type="text" name="bank_info_bank_name" label="Bank Name" placeholder="Enter Bank Name" value="{{ old('bank_info_bank_name') }}" required="true"/>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="bank_info_ac_no" name="bank_info_ac_no"
                                           ...
                                           class="form-control @error('bank_info_ac_no') is-invalid @enderror" value="{{ old('bank_info_ac_no') }}"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="bank_info_swift_code" name="bank_info_swift_code"
                                           ...
                                           class="form-control @error('bank_info_swift_code') is-invalid @enderror" value="{{ old('bank_info_swift_code') }}"
                                           maxlength="11"/>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="bank_info_ifsc_code" name="bank_info_ifsc_code"
                                           ...
                                           class="form-control @error('bank_info_ifsc_code') is-invalid @enderror" value="{{ old('bank_info_ifsc_code') }}"
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <x-input type="text" name="bank_info_branch" label="Branch" placeholder="Enter Branch" value="{{ old('bank_info_branch') }}" required="true"/>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <input type="text" id="bank_info_upi_id" name="bank_info_upi_id"
                                           ...
                                           class="form-control @error('bank_info_upi_id') is-invalid @enderror" value="{{ old('bank_info_upi_id') }}"
                                ...
                                <div class="col-md-6 col-lg-6">
                                    <x-input type="text" name="bank_info_payment_name" label="Payment Name" placeholder="Enter Payment Name" value="{{ old('bank_info_payment_name') }}" required="true"/>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6">
                                    ...
                                    <textarea name="bank_info_address" class="form-control @error('bank_info_address') is-invalid @enderror" rows="1" placeholder="Enter Address">{{ old('bank_info_address') }}</textarea>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#country_id').on('change', function () {
                ...
                // Reset and disable states & cities
                ...
                if(country_id) {
                    $.ajax({
                        ...
                        success: function (res) {
                            $("#state_id").html('<option value="">Select a state</option>'); // reset
                            var seen = {};
                            ...
                            $("#state_id").prop('disabled', false); // enable after data load
                        },
                        error: function() {
            ...
            $('#state_id').on('change', function () {
                ...
                if(state_id) {
                    $.ajax({
                        ...
                        success: function (res) {
                            $("#city_id").html('<option value="">Select a city</option>'); // reset
                            var seen = {};
                            $.each(res, function (key, value) {
                                var nameKey = value.name ? value.name.toLowerCase().trim() : value.id;
                                if (!seen[nameKey]) {
                            ...
                            $("#city_id").prop('disabled', false); // enable after data load
                        },
                        error: function() {
            ...
            $(document).on('click', '#checkGstButton', function () {
                let gstin = $('#tax_info_gst_no').val();
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            alert("GST Verified: " + response.legal_name);

                            // Auto fill date of registration
                            $('input[name="tax_info_gst_reg_date"]').val(response.reg_date);
                        } else {
                            alert(response.message || "Invalid GST Number!");
                        }
                    },
                    error: function () {
