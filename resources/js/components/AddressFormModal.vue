                ...
                {{ errors.phone[0] }}
                                      ...
                                      <div class="sm:col-span-4">
                                        ...
                                        <select
                                            ...
                                            class="form-input"
                                            :class="errors?.country_id ? 'border-red-500' : 'border-slate-200'"
                                        >
        ...
        {{ errors.country_id[0] }}
                                      ...
                                      <div class="sm:col-span-4">
                                        ...
                                        <input
                                            ...
                                            class="form-input"
                                            :class="errors?.post_code ? 'border-red-500' : 'border-slate-200'"
                                            maxlength="10"
                                        />

                                        <span v-if="errors?.post_code" class="text-red-500 text-sm">
                {{ errors.post_code[0] }}
            </span>
                                      </div>
                                      ...
                                      <div class="sm:col-span-4">
                                        ...
                                        <input
                                            ...
                                            class="form-input"
                                            :class="errors?.area ? 'border-red-500' : 'border-slate-200'"
                                        />
                ...
                {{ errors.area[0] }}
                                      ...
                                      <!-- Landmark -->
                                      <div class="sm:col-span-4">
                                        <label for="landmark" class="form-label mb-2">
                                          {{ $t('Landmark') }}
                    ...
                    ({{ $t('Optional') }})
                                        ...
                                        <input
                                            ...
                                            class="form-input"
                                            :class="errors?.flat_no ? 'border-red-500' : 'border-slate-200'"
                                        />

                                        <span v-if="errors?.flat_no" class="text-red-500 text-sm">
                {{ errors.flat_no[0] }}
            </span>
                                      </div>
                                      ...
                                      <div class="sm:col-span-12">
                                        ...
                                        <textarea
                                            ...
                                            class="form-input"
                                            :class="errors?.address_line ? 'border-red-500' : 'border-slate-200'"
                                        ></textarea>

                                        <span v-if="errors?.address_line" class="text-red-500 text-sm">
...
const addressFormSubmit = async () => {
  ...
  try {
    ...
    toast.error(
        error.response?.data?.message || 'Unable to create address',
        {
          position:
              masterStore.langDirection === 'rtl'
                  ? 'bottom-right'
...
const loadCountries = async () => {
  ...
  const india = countries.value.find(
      item => item.name.toLowerCase() === 'india'
  );

  if (india) {
    formData.value.country_id = india.id;
  }
};
</script>
